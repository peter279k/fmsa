...
observation_router.add_api_route('/ltc_tw_2025_observation_blood_pressure', generate_ltc_tw_blood_pressure_observation, methods=['POST'], description='Generate Blood Pressure Observation Resource')

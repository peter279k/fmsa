...
observation_router.add_api_route('/ltc_tw_2025_observation_blood_pressure', generate_ltc_tw_blood_pressure_observation, methods=['POST'], description='Generate Blood Pressure Observation Resource for LTC')
...
practitioner_role_router.add_api_route('/ltc_tw_2025_practitioner_role', generate_ltc_tw_for_practitioner_role, methods=['POST'], description='Generate PractitionerRole Resource for LTC')
...
location_router.add_api_route('/ltc_tw_2025_location_broken', generate_ltc_tw_location_circuit, methods=['POST'], description='Generate Location Resource for LTC Broken RQ5')
...
directed_upload_router = APIRouter(tags=['Upload specific resource with updating approach directly'], prefix='/api/v1')
directed_upload_router.add_api_route('/directed_upload/{resource_name}', directed_uploading_resource, methods=['PUT'], description='Upload the specific resource via FHIR Data Manager directly')

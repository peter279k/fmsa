...
def test_upload_required_references():
    ...
    with open('./api_gateway/app/tests/scenarios/Practitioner-ltc-practitioner-nurse-example.json') as f:
        json_str = f.read()
    ...
    with open('./api_gateway/app/tests/scenarios/Organization-ltc-organization-example.json') as f:
        json_str = f.read()
    ...
    response = httpx.put('http://127.0.0.1:8081/api/v1/update/Organization', headers=headers, json=payload, timeout=httpx.Timeout(60.0))

    assert response.status_code == 201 or response.status_code == 200

    with open('./api_gateway/app/tests/scenarios/PractitionerRole-ltc-practitioner-role-nurse-example.json') as f:
        json_str = f.read()
    ...
    with open('./api_gateway/app/tests/scenarios/Patient-ltc-patient-chen-ming-hui.json') as f:
        json_str = f.read()
    ...
    with open('./api_gateway/app/tests/scenarios/Practitioner-ltc-practitioner-example.json') as f:
        json_str = f.read()
    ...
    with open('./api_gateway/app/tests/scenarios/Location-ltc-location-example.json') as f:
        json_str = f.read()
...
def test_convert_upload_retrieve_observation_scenario1():
    ...
    with open('./api_gateway/app/tests/scenarios/Observation-ltc-observation-blood-pressure-example.json', 'r', encoding='utf-8') as f:
    ...
    response = httpx.post(f'http://127.0.0.1:8081/api/v1/ltc_tw_2025_observation_blood_pressure', headers=headers, json=json_dict)
    ...
    response = httpx.get(f'http://127.0.0.1:8081/api/v1/retrieve/Observation?_id={observation_id}', headers=headers)

    assert response.status_code == 200

@pytest.mark.dependency(depends=['test_upload_required_references'])
def test_convert_upload_retrieve_procedure_scenario2():
    with open('./api_gateway/app/tests/scenarios/procedure.json') as f:
    ...
    response = httpx.post(f'http://127.0.0.1:8081/api/v1/convert', headers=headers, json=payload)
    response_json = response.json()
    ...
    response = httpx.put(f'http://127.0.0.1:8081/api/v1/update/Procedure', headers=headers, json=payload)

    assert response.status_code == 201

    response = httpx.get(f'http://127.0.0.1:8081/api/v1/retrieve/Procedure?_id={procedure_id}', headers=headers)

    assert response.status_code == 200

@pytest.mark.dependency(depends=['test_upload_required_references'])
def test_convert_upload_retrieve_medication_administration_data():
    with open('./api_gateway/app/tests/scenarios/medication_administration.json') as f:
    ...
    response = httpx.put(f'http://127.0.0.1:8081/api/v1/update/MedicationAdministration', headers=headers, json=payload)

    assert response.status_code == 201

    response = httpx.get(f'http://127.0.0.1:8081/api/v1/retrieve/MedicationAdministration?_id={medication_admin_id}', headers=headers)
...
def test_analyze_upload_retrieve_questionnaire_response_cdr_data():
    ...
    for cdr_file in cdr_files:
        with open(f'./api_gateway/app/tests/scenarios/{cdr_file}') as f:
            contents = f.read()
    ...
    response = httpx.post(f'http://127.0.0.1:8081/api/v1/analyze', headers=headers, json=payload)
    response_json = response.json()
    ...
    response = httpx.put('http://127.0.0.1:8081/api/v1/update/QuestionnaireResponse', headers=headers, json=payload)
    assert response.status_code == 201

    response = httpx.get(f'http://127.0.0.1:8081/api/v1/retrieve/QuestionnaireResponse?_id={questionnaire_response_id}', headers=headers)
    assert response.status_code == 200

@pytest.mark.dependency(depends=['test_upload_required_references'])
def test_convert_upload_retrieve_location_data():
    with open('./api_gateway/app/tests/scenarios/location.json') as f:
    ...
    response = httpx.get(f'http://127.0.0.1:8081/api/v1/retrieve/Location?_id={location_id}', headers=headers)
    assert response.status_code == 200

@pytest.mark.dependency(depends=['test_upload_required_references'])
def test_convert_upload_retrieve_adverse_event_data():
    with open('./api_gateway/app/tests/scenarios/adverse_event.json') as f:
    ...
    response = httpx.put('http://127.0.0.1:8081/api/v1/update/AdverseEvent', headers=headers, json=payload)
    assert response.status_code == 201

    response = httpx.get(f'http://127.0.0.1:8081/api/v1/retrieve/AdverseEvent?_id={adverse_event_id}', headers=headers)
    assert response.status_code == 200
